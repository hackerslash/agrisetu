...
/**
 * Recursively sanitizes an object by redacting sensitive keys and patterns.
 */
export function sanitize(obj: any): any {
  ...
  // Preserve non-object types and common objects that shouldn't be recursed
  ...
  if (obj instanceof Error) {
    ...
    // Copy other custom properties from the error object and sanitize them
